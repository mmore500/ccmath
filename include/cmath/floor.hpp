...
#ifndef CCMATH_FLOOR_HPP
#define CCMATH_FLOOR_HPP
...
{
    return ccmath::floor(static_cast<double>(arg));
}

inline constexpr float floorf(float arg) noexcept
{
    return ccmath::floor(arg);
}
